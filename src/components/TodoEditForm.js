  ...
  render() {
    return (
        ...
        <form id="EditTodoForm" onSubmit={this.submitEditTodo}>
            <label> Text: </label>
            <input type="hidden" defaultValue={this.props.todoData._id} name="id"/>
            <input name='text' defaultValue={this.props.todoData.todoText} type="text" /><br/>
            <label> Description: </label>
            <input name='name' defaultValue={this.props.todoData.todoDesc} type="text" /><br/>
